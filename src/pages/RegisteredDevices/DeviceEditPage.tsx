          ...
          <form className="grid gap-5 md:grid-cols-2" onSubmit={handleSubmit}>
            ...
            <div className="md:col-span-2">
              <fieldset className="rounded-xl border border-slate-800 bg-slate-900/40 px-4 py-4">
                ...
                <p className="mt-3 text-xs text-slate-400">
                  Switch between password and key-based authentication. Saving a
                  key pair will generate and encrypt a new private key for this
                  device.
                </p>
              </fieldset>
            </div>
            {formState.authMethod === "password" ? (
              ...
              <div className="md:col-span-2 rounded-xl border border-emerald-500/40 bg-emerald-500/10 px-4 py-4 text-sm text-emerald-200">
                Nodex stores the device private key encrypted. Install the
                public key on the device after saving to complete the switch.
              </div>
            )}
            {status.error ? (
              ...
              <div className="md:col-span-2 space-y-3 rounded-xl border border-emerald-500/40 bg-emerald-500/10 px-4 py-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-emerald-100/80">
                    Copy this key to the device's authorized_keys file to allow
                    Nodex to authenticate.
                  </p>
                </div>
                <textarea
